...
### Summary
Este release amplia de forma expressiva os recursos de automação de Git e de integração com editores, com destaque para o suporte a múltiplos idiomas e a padronização das traduções. Foram adicionados provedores de repositório alternativos, suporte a novos modelos de inteligência artificial e um fluxo completo de geração e publicação de pull requests, incluindo sugestão de revisores, mensagens automáticas de commit e tratamento de mesclagem. Também chega um painel de métricas com exportação de dados, integração com editores por meio de servidores de ferramentas e assistentes interativos de configuração. Diversas correções reforçam a estabilidade e a segurança, prevenindo injeção de comandos, limitando tempos de operações de rede e resolvendo travamentos do servidor. Por fim, o processamento de grandes alterações ficou mais eficiente e econômico, com melhor tratamento de arquivos, commits e exclusões inteligentes.
