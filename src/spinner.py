...
# Palavras que representam "pensamento" da IA
THINKING_WORDS = [
    "Fabuloso", "Pensando", "Analisando", "Raciocinando",
    "Elaborando", "Processando", "Decifrando", "Calculando",
    "Refletindo", "Maquinando", "Engenhando", "Arquitetando",
    "Destilando", "Codificando", "Iterando", "Purificando", 
    "Contextualizando", "Apreciando", "Desmitificando", "Aglomerado",
    "Sofisticando", "Populando", "Sincronizando",
]
